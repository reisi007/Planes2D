...
public class CloudManager implements IGameObject {
    ...
    public CloudManager(int numberOfClouds, TextureRegion sprite, float totalWidth, float bottomRegion, float topRegion, float height100) {
        ...
        original = new Moveable(sprite, Vector2.Zero, Vector2.Zero, 0, IFullGameObject.Anchor.LowLeft, height100, false, false, false);
    ...
    private void getCloudPosition(Moveable tmp, float from, float to) {
        ...
        tmp.setPosition(IFullGameObject.Anchor.TopLeft, Helper.getRandomInRange(from, to), Helper.getRandomInRange(bottomRegion, topRegion));
    }
