...
public class Planes2D extends Game {
    ...
    public void Update(GameTime.GameTimeArgs gameTime) {
        ...
        switch (GScurrent) {
            ...
            case PrepearScore:
                ...
                dtGameover = new DrawableText(iNative.GameOverMessage(SCORE, SCORE >= HIGHSCORE), 0.95f * curW, true, curW / 2f, 2f / 3 * curH, IDrawable.Anchor.MiddleMiddle, Color.WHITE);
    ...
    private void updateScore(int add) {
        ...
        if (HIGHSCORE < SCORE)
            HIGHSCORE = SCORE;
        dtScore.updateText("Score: " + SCORE + "     Highscore: " + HIGHSCORE);
    }
